...
public class TestUserProfileHandler {
  ...
  public void testNoTokenInParams() throws IOException {
    ...
    HttpURLConnection clientConnection = tryRequest("getUser");
  ...
  public void testEmptyToken() throws IOException {
    ...
    HttpURLConnection clientConnection = tryRequest("getUser?token=");
    assertEquals(200, clientConnection.getResponseCode());
  ...
  public void testBadToken() throws IOException {
    ...
    HttpURLConnection clientConnection = tryRequest("getUser?token=113131");
    assertEquals(200, clientConnection.getResponseCode());
