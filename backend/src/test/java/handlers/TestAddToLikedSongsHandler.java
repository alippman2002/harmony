...
public class TestAddToLikedSongsHandler {
  ...
  public void testNoTokenInParams() throws IOException {
    ...
    HttpURLConnection clientConnection = tryRequest("addLike");
  ...
  public void testEmptyToken() throws IOException {
    ...
    HttpURLConnection clientConnection = tryRequest("addLike?token=");
    assertEquals(200, clientConnection.getResponseCode());
  ...
  public void testBadToken() throws IOException {
    ...
    HttpURLConnection clientConnection = tryRequest("addLike?token=113131");
    assertEquals(200, clientConnection.getResponseCode());
